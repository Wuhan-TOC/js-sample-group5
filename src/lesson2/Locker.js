import { StatusEnum, STORE_PACKAGE_ERROR, GET_PACKAGE_ERROR, getRandomInt, getRandomString, GET_PACKAGE_SUCCESS } from ".";
...
export default class Locker {
  ...
  storePackage = () => {
    ...
    let randomId = getRandomInt(this.totalCount);
    let box = this.boxArr[randomId];
